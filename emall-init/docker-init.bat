...
REM 启动应用容器
docker run -d --rm --name emall-service-user --network emall-network -p 20880:20880 -e DUBBO_IP_TO_REGISTRY=10.10.17.96 emall-service-user:1.0.0

docker run -d --rm --name emall-service-facade -p 80:80 --network emall-network emall-service-facade:1.0.0